...
export default function AdminPage() {
  ...
  return (
    <div style={{minHeight:'100vh',background:'var(--bg)',color:'var(--text-primary)',fontFamily:'inherit'}}>
      ...
      <header className="admin-header" style={{position:'sticky',top:0,zIndex:30,background:'var(--bg-nav)',backdropFilter:'blur(12px)',borderBottom:'1px solid var(--surface-border)',display:'flex',alignItems:'center',justifyContent:'space-between',height:60}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:8}}>
          ...
          <Link href="/" className="admin-back-btn" style={{padding:'6px 14px',borderRadius:8,background:'transparent',border:'1px solid var(--surface-border)',fontSize:13,color:'var(--text-secondary)',textDecoration:'none'}}>← Voltar</Link>
        </div>
      </header>

      <div className="admin-content" style={{maxWidth:1100,margin:'0 auto'}}>
        <div className="admin-tabs" style={{display:'flex',gap:4,marginBottom:28,borderBottom:'1px solid var(--surface-border)'}}>
        ...
        {tab==='titles' && (
          <div>
            <div className="admin-filters" style={{display:'flex',gap:12,marginBottom:24,flexWrap:'wrap'}}>
              ...
              <div className="filter-buttons" style={{display:'flex',gap:6}}>
            ...
            {loading ? (
              ...
              <div style={{display:'flex',flexDirection:'column',gap:8}}>
                {filtered.map(t=>(
                  <div key={t.id} className="title-row" style={{display:'flex',alignItems:'center',gap:16,padding:'14px 18px',background:'var(--surface-card)',border:'1px solid var(--border-card)',borderRadius:12}}>
                    <div className="title-cover" style={{width:46,height:64,borderRadius:8,flexShrink:0,background:'var(--card-bg)',overflow:'hidden',border:'1px solid var(--card-border)'}}>
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      ...
                      <div className="title-meta" style={{display:'flex',gap:12,alignItems:'center',flexWrap:'wrap'}}>
                    ...
                    <div className="title-actions" style={{display:'flex',gap:6,flexShrink:0}}>
        ...
        {tab==='add' && (
          <div className="add-form" style={{maxWidth:680}}>
            ...
            <div className="form-actions" style={{display:'flex',gap:12,marginTop:28}}>
