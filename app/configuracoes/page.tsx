...
export default function SettingsPage() {
  ...
  return (
    <main style={{width:'100%',minHeight:'100vh',background:'#08080c',color:'white',paddingTop:88,paddingBottom:64,paddingLeft:40,paddingRight:40}}>
      <div style={{maxWidth:'auto'}}>
        <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:6}}>
          ...
          <h1 style={{fontSize:28,fontWeight:700,color:'white'}}>Configurações</h1>
        </div>
